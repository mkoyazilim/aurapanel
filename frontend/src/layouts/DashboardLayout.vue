...
const routeTitleKeys = {
  ...
  'Docker Images': 'layout.links.image_manager',
  'Docker Containers': 'layout.links.container_manager',
  'Docker Create': 'layout.links.create_container',
  'Docker App Store': 'layout.links.app_store',
  'Docker Installed Apps': 'layout.links.installed_apps',
  'Docker Packages': 'layout.links.docker_packages',
...
const commandItems = computed(() => [
  ...
  { label: t('layout.links.image_manager'), path: '/docker/images' },
  { label: t('layout.links.container_manager'), path: '/docker/containers' },
  { label: t('layout.links.app_store'), path: '/docker/apps' },
