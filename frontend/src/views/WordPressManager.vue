  ...
  <div class="space-y-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div class="flex flex-wrap items-center gap-3">
        <router-link :to="{ path: '/app-runtime' }" class="btn-secondary">{{ t('wordpress_manager.cms_installation') }}</router-link>
      ...
      <section class="rounded-2xl border border-panel-border bg-panel-card">
        ...
        <div v-else-if="sites.length === 0" class="space-y-4 px-5 py-10 text-center">
          ...
          <div class="flex justify-center gap-3">
            <router-link :to="{ path: '/app-runtime' }" class="btn-secondary">{{ t('wordpress_manager.go_install') }}</router-link>
