...
export const ROLE_PERMISSION_CATALOG = Object.freeze([
  ...
  { key: 'packages.manage', label: 'Package Management' },
  { key: 'reseller.manage', label: 'Reseller/ACL Management' },
  { key: 'websites.manage', label: 'Website Management' },
  { key: 'dns.manage', label: 'DNS Management' },
  { key: 'databases.manage', label: 'Database Management' },
  { key: 'mail.manage', label: 'Email Management' },
  { key: 'ftp.manage', label: 'FTP Management' },
  { key: 'sftp.manage', label: 'SFTP Management' },
  { key: 'backups.manage', label: 'Backup Management' },
  { key: 'apps.manage', label: 'App/WordPress/Plugin' },
  { key: 'runtime.manage', label: 'Docker/Runtime Management' },
  { key: 'files.manage', label: 'File Manager' },
  { key: 'terminal.manage', label: 'Web Terminal' },
  { key: 'php.manage', label: 'PHP Management' },
  { key: 'ssl.manage', label: 'SSL Management' },
  { key: 'security.manage', label: 'Security Management' },
  { key: 'monitoring.read', label: 'Server Status' },
  { key: 'logs.read', label: 'Log Viewer' },
  { key: 'cron.manage', label: 'Cron Management' },
  { key: 'cloudflare.manage', label: 'Cloudflare Management' },
  { key: 'migration.manage', label: 'Migration Wizard' },
  { key: 'cloudlinux.manage', label: 'CloudLinux Management' },
  { key: 'minio.manage', label: 'MinIO Management' },
  { key: 'activity.read', label: 'Activity Logs' },
  { key: 'ops.manage', label: 'Ops/Federated Management' },
  { key: 'panel.manage', label: 'Panel Management' },
