      ...
      <div v-else>
        ...
        <div class="card">
          ...
          <div v-else>
            ...
            <button @click="showCreateModal = true" class="btn primary">{{ $t('staging.create_staging_environment') }}</button>
          </div>
        </div>
      </div>
        ...
        <div class="modal-card">
          ...
          <form @submit.prevent="createStaging">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 8px; margin-top: 24px;">
              <button type="button" class="btn" @click="showCreateModal = false">{{ $t('staging.cancel') }}</button>
